...
import { Productservice, ProductPage, Product } from '../../../core/services/productservice';
import { ProductService as AdminProductService } from '../../../core/services/adminproductservice';
  ...
  loadProducts() {
    ...
    this.productService.getProductList().subscribe({
      next: (page: ProductPage) => {
        this.products = page.content.map(this.mapProductToListItem);
        this.applyFilters();
      },
      error: (error: any) => {
  ...
  applyFilters() {
    ...
    if (this.selectedCategory) {
      this.productService.getProductsByCategory(this.selectedCategory).subscribe({
        next: (page: ProductPage) => {
          const listItems = page.content.map(this.mapProductToListItem);
